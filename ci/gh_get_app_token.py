...
def main():
    ...
    argparser.add_argument("--private-key-path", help="Path to the private key", required=True)
    argparser.add_argument("--installation_id", help="GitHub App installation ID. If not given the first one is picked", required=False)
    ...
    print("access token:", access_token.token, "expires at:", access_token.expires_at.isoformat())
